...
import {  SupportedCountries, CardDiscounts, IbanAccounts } from "../../components";
...
const handleCreate = (e) => {
 ...
 navigate('/signup')
    ...
    return(
     <div className="h-screen md:h-[800px]  relative overflow-hidden">
       <div className=" px-2 pt-2 grid md:grid-cols-12 sm:px-8 sm:items-start sm:py-8 sm:gap-x-8 ">
      <div className="col-span-6 lg:pt-10 z-10 ">
    <div onClick={() => handleCreate("Checking")} className="hidden lg:flex justify-start pb-4 cursor-pointer">
      <a className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 pl-3 rounded-full transition hover:border-gray-300   " >
      ...
      <div className="">
            <div className="">
              <h1 className="block text-3xl font-bold text-gray-50 sm:text-4xl lg:text-6xl  lg:tracking-wide ">
                Banking done your way with{" "}
                <span className="text-teal-400">Savely</span>
              </h1>
              <p className="mt-3 text-lg text-gray-50 ">
                Built by banking professionals with a focus on budgeting, open
                an account with savely today with $0 with a few clicks.
              </p>
            </div>
            ...
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
                ...
                className="inline-flex justify-center items-center gap-x-3 text-center bg-teal-400 hover:bg-teal-600 cursor-pointer border border-transparent text-sm  text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4 lg:w-1/2 lg:text-lg "
              >
                Get started
                <svg
              ...
              {/* <a
                href="#faq"
                className="inline-flex text-gray-50 justify-center items-center gap-x-3.5 text-sm lg:text-base text-center border hover:border-gray-300 shadow-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition py-3 px-4     "
              >
                View Faq
              </a> */}
            </div>
            ...
            <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
              ...
              <div className="py-5">
                ...
                <div className="mt-5">
                  {/* <!-- Star --> */}
                  <svg
                    className="h-auto w-16 text-gray-50 "
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
      ...
      <div className="col-span-6 sm:absolute sm:-bottom-64 md:bottom-auto right-0 lg:-right-10 ">
      {/* <Browsermockup/> */}
      <img src="https://cdn.sanity.io/images/9tj5asa4/production/b801b325ebbf6d205d5f397e19cd2d874112459f-630x892.png" alt="" />
      </div>
      </div>
      <div className=" absolute bottom-0 inset-x-0 lg:-z-10">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#2dd4bf" fill-opacity="1" d="M0,224L40,240C80,256,160,288,240,293.3C320,299,400,277,480,234.7C560,192,640,128,720,90.7C800,53,880,43,960,64C1040,85,1120,139,1200,149.3C1280,160,1360,128,1400,112L1440,96L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
      </div>
