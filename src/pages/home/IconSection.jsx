  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
    ...
    <div className="w-full h-full bg-white shadow-lg rounded-lg p-5 ">
      <div className="flex items-center gap-x-4 mb-3">
        <div className="inline-flex justify-center items-center w-[62px] h-[62px] rounded-full border-4 border-blue-50 bg-blue-100  ">
          <svg className="w-6 h-6 text-blue-600 " xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="flex-shrink-0">
          <h3 className="block text-lg font-semibold text-gray-800 ">Easy Funding</h3>
        </div>
      </div>
    ...
    <div className="w-full h-full bg-white shadow-lg rounded-lg p-5 ">
      <div className="flex items-center gap-x-4 mb-3">
        ...
        <div className="flex-shrink-0">
          <h3 className="block text-lg font-semibold text-gray-800 ">Budgeting tools</h3>
        </div>
      </div>
    ...
    <div className="w-full h-full bg-white shadow-lg rounded-lg p-5 ">
      <div className="flex items-center gap-x-4 mb-3">
        ...
        <div className="flex-shrink-0">
          <h3 className="block text-lg font-semibold text-gray-800 ">Account Protection</h3>
        </div>
      </div>
