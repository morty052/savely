...
const handleCreate = (e) => {
 ...
 navigate('/signup')
  ...
  return (
    <div className="bg-slate-800 relative  py-8 ">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          ...
          <div className=" ">
            <div className="">
              <h1 className="block text-3xl font-bold text-gray-50 sm:text-4xl lg:text-6xl lg:leading-tight ">
                Get Discounts With{" "}
                <span className="text-teal-600">Savely Debit Card</span>
              </h1>
              <p className="mt-3 text-lg text-gray-50 ">
                Built by banking professionals with a focus on budgeting, open
                an account with savely today with $0.
              </p>
            </div>
          ...
          {/* "IMAGE" */}
          <div className="relative  sm:p-10 lg:p-8">
            <img className="w-full " src={cards} alt="Image Description" />
          </div>
