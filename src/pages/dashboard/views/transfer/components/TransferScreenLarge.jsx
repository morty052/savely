...
import {TransferReceiptModal} from "./"


const TransferScreenLarge = ({activeAccount, setwithdrawing}) => { 
    ...
    return(
        ...
        <div className=" relative sm:border  sm:bg-white sm:px-4  sm:rounded-2xl sm:py-6 sm:shadow-xl  ">
          <div className="">
            <p className="text-xl font-semibold text-blk text-center">
              Transfer from {activeAccount?.type}
            </p>
              ...
              <div className="col-span-4">
                ...
                <div className="flex items-center gap-x-4 pt-6">
                  ...
                  <div className="">
                    ...
                    <AccountsInput placeholder={"Choose Destination"} setbeneficiary={setaccount} people={beneficiaries}/>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col py-6 sm:py-0">
                  <div>
                    ...
                    <div className="py-2">
                      ...
                      /> */}
                      <CurrencyInput setAmount={setamount} value={withdrawAmount} setValue={setWithdrawAmount} placeholder={"Enter Amount to Transfer"}/>
                    </div>
                  </div>
                </div>
      ...
      <TransferReceiptModal isOpen={Transferring} setIsOpen={setTransferring}/>
      </>
        )
  }

export default TransferScreenLarge