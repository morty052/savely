...
const TransferReceiptModal = ({isOpen, setIsOpen,id, amount, beneficiary, account, remainder}) => {
...
{/* <!-- End Body --> */}
  ...
  return (
    // <Transition className={" "} show={isOpen} as="div">
    // </Transition>
       <Dialog open={isOpen} className={"fixed inset-0"}   onClose={setIsOpen}>
        <Dialog.Overlay className={"fixed inset-0 bg-black bg-opacity-50 "}/>
         <Dialog.Panel className={" lg:ml-[258px] py-4 lg:py-8 z-10 "}>
             <TransferReceipt/>
         </Dialog.Panel>
       </Dialog>
  )
