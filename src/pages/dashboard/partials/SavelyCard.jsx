...
import { virtualLogo, masterlogo } from '../../../assets';


function SavelyCard({firstname, lastname, amount, func, number, issued, expires}) {
    ...
    <>
      <div onClick={func} className="my-4  font-space  rounded-2xl ">
        ...
        >
          ...
          <img src={virtualLogo}  alt="" className="w-36  " />
            {/* <h3 className="text-lg text-white font-black ">Savely</h3> */}
          </div>
          ...
          {/* BACKGROUND GRADIENT */}
          <div className="bg-gradient-to-r from-blue-400 to-blue-700 absolute inset-0 opacity-75 rounded-xl shadow-inner  "></div>
